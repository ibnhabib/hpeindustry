...
<html lang="en">
    ...
    <!-- Show Products Thumbnails -->

    <?php
    if ($has_categories):
        echo "This Section has categories";
        include_once($project_root_folder . '/views/partials/thumbs_with_categories.view.php');
    else:
        include_once($project_root_folder . '/views/partials/thumbs_no_categories.view.php');
    endif;
    ?>
